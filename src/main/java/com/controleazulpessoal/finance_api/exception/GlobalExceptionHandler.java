...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUsuarioAlreadyExistsException(UserAlreadyExistsException ex) {
        return buildErrorResponse(HttpStatus.CONFLICT, "Usuário já existe", ex);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleUsuarioNotFoundException(UserNotFoundException ex) {
        return buildErrorResponse(HttpStatus.NOT_FOUND, "Usuário não encontrado", ex);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleIllegalArgumentException(IllegalArgumentException ex) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Requisição inválida", ex);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(Exception ex) {
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Erro interno no servidor", ex);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleUsuarioNaoAutenticadoException(UserNotAuthenticatedException ex) {
        return buildErrorResponse(HttpStatus.UNAUTHORIZED, "Falha na autenticação", ex);
    }
        ...
        Map<String, String> fieldErrors = ex.getBindingResult()
                ...
                .collect(
                        java.util.stream.Collectors.toMap(
                                ...
                                (msg1, msg2) -> msg1 // caso existam erros repetidos para o mesmo campo
                        )
                );
